...
Solution of task 11.7 - The string presentation of fractions:


Learning Goals:
To familiarize yourself with the method __str___, which forms a
 presentation in the string format.
"""
