...
6.2 - Project: Energy statistic:
 Implement a program capable of printing energy cunsumption histograms based
  on the data the user entered. The energy consumption values will be
  divided into classes based on a logarithmic scale. In practise this
  means that the limits of the classes (or categories) of the values will
  differ from each other by multiples of 10.
